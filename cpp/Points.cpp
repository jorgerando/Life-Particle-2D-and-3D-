...
class Interactor {
 ...
 public :
   ...
   void positioning(int i , float px , float py){
      this->particles[i].set_p(px,py);
   }
   ...
   void drawF(sf::RenderWindow& window){
...
int main() {
   ...
   Interactor inter(TYPES,602+587) ;

   std::string nombre_archivo = "RandoCode.txt";
   ...
   if (archivo.is_open()) {
        ...
        while (std::getline(archivo, linea)) {
          ...
          char comma; // Para almacenar la coma

          if (i < 602){

          if (ss >> numero1 >> comma >> numero2) {
                std::cout << "Número 1 como entero: " << numero1 << std::endl;
                std::cout << "Número 2 como entero: " << numero2 << std::endl;
                inter.positioning(i,numero1*2 + 450 , numero2*2 + HEIGHT/2 - 400 );
                i++;
          } else {
            std::cerr << "Error al procesar la línea." << std::endl;
          }
          ...
          if (ss >> numero1 >> comma >> numero2) {
                std::cout << "Número 1 como entero: " << numero1 << std::endl;
                std::cout << "Número 2 como entero: " << numero2 << std::endl;
                inter.positioning(i,numero1*2 + 450 , numero2*2 + HEIGHT/2 - 100  );
                i++;
          } else {
            std::cerr << "Error al procesar la línea." << std::endl;
          }
